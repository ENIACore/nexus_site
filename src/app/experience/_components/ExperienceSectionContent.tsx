...
const ExperienceSectionContent: React.FC = () => {
    return (
        <div className="flex flex-col">
            ...
            <Paragraph classes="mb-4" text="After graduation, I joined IBM, where I currently work on large-scale systems for Medi-Cal. This role gave me experience with enterprise development and cross-team coordination on systems serving millions of users."/>
        </div>
    );
};
